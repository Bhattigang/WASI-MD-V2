...
module.exports = {
  ...
  caption: process.env.CAPTION || "𝐅𝐈𝐋𝐄-𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃-𝐁𝐘-FaheemHacker-𝐌𝐃-𝐕2😍",
  author: process.env.PACK_AUTHER || "WASO",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "FaheemHacker-𝐌𝐃-𝐕2",
  ownername: process.env.OWNER_NAME || "Faheemhacker",
